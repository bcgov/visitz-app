...
{
    static List<VisitJson> Parent123Visits =>
        [
            new()
            {
    ...
    static List<VisitJson> Parent80Visits =>
        [
            new()
            {
    ...
    public async Task SynchronizeAsyncDeletesDifferenceFromRealm()
    {
        ...
        await PersonVisit.SynchronizeAsync(realm, Parent80Visits, "80");
        await PersonVisit.SynchronizeAsync(realm, Parent123Visits, "123");
        var numberOfPersonVisitsBeforeDeletion = realm.All<PersonVisit>().Count();

        //Checking deletion of realm objects
        await PersonVisit.SynchronizeAsync(realm, Parent123Visits.Skip(1), "123");
