    ...
    public static List<PersonVisit> MockPersonVisits(string parentId = "1-0000000")
    {
        ...
        return [
            ...
            new()
            {
                ...
                VisitDetailsValue = PersonVisitDetails.Type_PrivateVisit,
                VisitDetailsGroup = PersonVisitDetails.Details_NotInHome,
                LoginName = "SOMEUSER",
            ...
            new()
            {
                ...
                DateOfVisit = DateTimeOffset.UtcNow.AddDays(-14),
                VisitDetailsValue = PersonVisitDetails.Type_PrivateVisit,
                VisitDetailsGroup = PersonVisitDetails.Details_MedicalOrSupportNeeds,
                LoginName = "SOMEUSER",
                Created = DateTimeOffset.UtcNow.AddDays(-14),
                Updated = DateTimeOffset.UtcNow.AddDays(-7),
                CreatedBy = "SOMEUSER",
