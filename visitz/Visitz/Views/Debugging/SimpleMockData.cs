    ...
    public static List<PersonVisit> MockPersonVisits(string parentId = "1-0000000")
    {
        ...
        return [
            new()
            {
                ...
                ParentId = parentId,
                Name = "1-1A2B3C4",
                VisitDescription = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
                DateOfVisit = DateTimeOffset.UtcNow.AddDays(-14),
                VisitDetailsValue = PersonVisitDetails.Type_NotPrivate,
                VisitDetailsGroup = PersonVisitDetails.Details_PlanningMeeting,
                LoginName = "SOMEUSER",
            ...
            new()
            {
                ...
                ParentId = parentId,
                Name = "1-1A2B3C5",
                VisitDescription = "Space, the final frontier. These are the voyages of the Starship Enterprise. Its five-year mission: to explore strange new worlds, to seek out new life and new civilizations, to boldly go where no man has gone before. Many say exploration is part of our destiny, but it’s actually our duty to future generations and their quest to ensure the survival of the human species.",
                DateOfVisit = DateTimeOffset.UtcNow.AddDays(-24),
                VisitDetailsValue = PersonVisitDetails.Type_Private,
                VisitDetailsGroup = PersonVisitDetails.Details_VisitNotInHome,
                LoginName = "SOMEUSER",
